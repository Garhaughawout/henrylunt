...
(function ($) {
    ...
    $.fn.abigimage.defaults = {
        ...
        overlayCSS: {
            position: 'fixed', zIndex: 101, top: 0, right: 0, bottom: 0, left: 0,
        ...
        prevBtnCSS: {
            color: '#fff', backgroundColor: '#000', opacity: .5,
        ...
        imgCSS: {
            position: 'absolute', zIndex: 102, margin: 'auto', width: 'auto',
            top: 0, right: 0, bottom: 0, left: 0,
            display: 'block', cursor: 'pointer', maxWidth: '32%', maxHeight: '100%'
        },
        imgNextCSS: {
            position: 'absolute', margin: 'auto', width: 'auto',
        ...
        bottomCSS: {
            position: 'fixed', zIndex: 104, right: 0, bottom: 0, left: 0,
