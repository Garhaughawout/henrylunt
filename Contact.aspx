...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
    <title>Henry Lunt - Contact Request</title>
...
<body>
        ...
        <form id="form1" runat="server">
          ...
          <div id="content_Xlarge"  >
              ...
              <asp:Label ID="lblStatus" runat="server" Text="<-- Click, I'm not a robot, check box prior to clicking 'Submit'" Font-Size="X-Large" style="position: absolute; left: 550px; top: 510px;" ></asp:Label>
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (ctrlGoogleReCaptcha.Validate())
        {
            try
            {
                ...
                mail.Subject = txtEmailAddress.Text + " left a comment when visiting henrylunt.org web site!";
                ...
                lblStatus.Text = "Your comment has been emailed to site administrator";
